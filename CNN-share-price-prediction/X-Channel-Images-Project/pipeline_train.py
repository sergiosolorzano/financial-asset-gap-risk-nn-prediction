...
def train_process(train_loader, params, run_id, experiment_name, device, stock_params):
    ...
    # train cnn
    net, model_signature, train_stack_input, feature_maps_cnn_list, feature_maps_fc_list = neural_network.Train(params, train_loader, net, run_id, experiment_name, device, stock_params)
