...
#             print(f"\033[91mssim_score {layer_type} {ssim_score}\033[0m")
#             image_similarity = {f"\033[91mSSIM_{layer_type}\033[0m":ssim_score.item()}
#         else:
#             print(f"\033[91mssim_score Input Images: {ssim_score}\033[0m")
...
#         "adam_beta": Parameters.adam_betas,
#         "cyclicLRWithRestarts_restart_period": Parameters.cyclicLRWithRestarts_restart_period,
#         "cyclicLRWithRestarts_cyclic_policy": Parameters.cyclicLRWithRestarts_cyclic_policy,
#         "cyclicLRWithRestarts_t_mult": Parameters.cyclicLRWithRestarts_t_mult,
#         "use_clip_grad_norm":Parameters.use_clip_grad_norm,
#         "grad_norm_clip_max":Parameters.grad_norm_clip_max,
#         "reduceLROnPlateau_patience": Parameters.reduceLROnPlateau_patience,
#         "reduceLROnPlateau_mode": Parameters.reduceLROnPlateau_mode,
#         "reduceLROnPlateau_enable_reset": Parameters.reduceLROnPlateau_enable_reset,
#         "reduceLROnPlateau_reset_rate": Parameters.reduceLROnPlateau_reset_rate,
#         "reduceLROnPlateau_reset_threshold": Parameters.reduceLROnPlateau_reset_threshold,
#         "reduceLROnPlateau_factor": Parameters.reduceLROnPlateau_factor,
#         "reduceLROnPlateau_min_lr": Parameters.reduceLROnPlateau_min_lr,
#         "oneCycleLR_max_lr": Parameters.oneCycleLR_max_lr,
#         "oneCycleLR_pct_start": Parameters.oneCycleLR_pct_start,
...
#                                             if Parameters.train:
#                                                 net, train_stack_input, train_feature_maps_cnn_list, train_feature_maps_fc_list = pipeline_train.train_process(train_loader, train_feature_image_dataset_list_f32, Parameters, run, run_id, experiment_name, device, stock_params)
