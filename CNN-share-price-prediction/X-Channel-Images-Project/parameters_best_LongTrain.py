#region FITB-KEY (FROM CFG-KEY): Eval R^2: 91%
...
#region CFG_RF (FROM CFG+KEY-RF BEST STABLE RUN)
# from sklearn.preprocessing import StandardScaler,MinMaxScaler
# import sys
# import os
# from enum import Enum
...
#     enable_save_model = False
#     mlflow_experiment_name = 'gaprisk-longhistory'
#     mlflow_experiment_description = "Concat stocks or extend stocks history"
#     run_id = None
