#region CFG-KEY WITHOUT BATCHNORM: BEST STABLE
...
#region CFG+KEY-RF BEST STABLE RUN
# from sklearn.preprocessing import StandardScaler,MinMaxScaler
# import sys
# import os
# from enum import Enum
...
#     #pytorch Schedulers
#     scheduler_type = "CyclicLRWithRestarts" #ReduceLROnPlateau, OneCycleLR, CyclicLRWithRestarts, BayesianLR, None
#     scheduler = None  
...
#     reduceLROnPlateau_factor = 0.1
#     reduceLROnPlateau_min_lr = 1e-4 #can only be higher than 1e-8
...
#region CFG-RF: STABLE BUT CAPPED EVALUATION R^2
# from sklearn.preprocessing import StandardScaler,MinMaxScaler
# import sys
# import os
# from enum import Enum
...
#     batch_regul_type_conv = "Norm2" #Norm2, Group
#     batch_regul_type_fc = "Norm2" #Norm, Group, LayerNorm
#     use_goupnorm = True
#     bn1_num_groups = 5  # Conv1: 40 channels / 5 groups = 8 channels per group
#     bn2_num_groups = 3  # Conv2: 12 channels / 3 groups = 4 channels per group
#     bn3_num_groups = 0  # Not used in "Average" complexity
...
#region CFG-RF WITH BATCH NORM VOLATILE EVALUATION R^2:
# from sklearn.preprocessing import StandardScaler,MinMaxScaler
# import sys
# import os
# from enum import Enum
...
#     #pytorch Schedulers
#     scheduler_type = "ReduceLROnPlateau" #ReduceLROnPlateau, OneCycleLR, CyclicLRWithRestarts, BayesianLR
#     scheduler = None    
...
#     #ReduceLROnPlateau Scheduler:
#     reduceLROnPlateau_patience = 100 #10000 to ignore lrscheduler
#     reduceLROnPlateau_reset_cooldown = 30
#     reduceLROnPlateau_mode = 'min'
#     reduceLROnPlateau_enable_reset = True
#     reduceLROnPlateau_reset_rate = 0.1#manual reset rate, will be ratched down by factor in scheduler.step
#     reduceLROnPlateau_factor = 0.1
