...
class Parameters:
    ...
    num_epochs_input = 12000

    min_best_cum_loss = torch.tensor(2.5, device=device, dtype=torch.float64)
    save_model_at_epoch_multiple = 1000
    model_uuid = 1#str(uuid.uuid4())

    loss_stop_threshold = 0.000002#0.0000013
    use_mixed_precision = False

    #pytorch Schedulers for Adam, Adamw and SGD optimizers
    ...
    max_stale_loss_epochs = 300 #100000 to ignore lrscheduler #max(4 * lr_scheduler_patience,300)
    ...
    #adamw optimizer
    adamw_weight_decay = 0.00001#0.00001#0.000001
